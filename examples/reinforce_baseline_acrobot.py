...
from agents.reinforce_baseline import REINFORCEBaseline
...
parser.add_argument('-ex', '--experiment_name', default='reinforce_baseline_acrobot', type=str, help='name of the experiment')
...
with tf.Session() as sess:
    ...
    np.savez(args.output_dir + "/" + args.experiment_name, stats=averaged_stats)
